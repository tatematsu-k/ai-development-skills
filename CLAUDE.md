...
| Terraform/IaC | `terraform-patterns`, `terraform-testing`, `terraform-security` |
...
| sonnet | `build-error-resolver`, `code-reviewer`, `database-reviewer`, `doc-architect`, `docs-lookup`, `e2e-runner`, `harness-optimizer`, `loop-operator`, `refactor-cleaner`, `security-reviewer`, `tdd-guide`, `typescript-reviewer`, `rails-reviewer`, `rails-build-resolver`, `terraform-reviewer` |
| haiku | `doc-updater` |
