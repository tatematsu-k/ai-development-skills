...
| sonnet | `build-error-resolver`, `code-reviewer`, `database-reviewer`, `docs-lookup`, `e2e-runner`, `harness-optimizer`, `loop-operator`, `refactor-cleaner`, `security-reviewer`, `tdd-guide`, `typescript-reviewer`, `rails-reviewer`, `rails-build-resolver`, `terraform-reviewer` |
| haiku | `doc-updater` |
